ProgressDialog
Roku OS 10.0 introduced a new StandardProgressDialog node , which features updated graphics and color palette support. This enables developers to provide a consistent user experience across the progress dialogs in their app. Developers should replace the legacy ProgressDialog nodes in their app with the new StandardProgressDialog nodes .
...
Sample app
ProgressDialogExample is a sample app demonstrating ProgressDialog in action.