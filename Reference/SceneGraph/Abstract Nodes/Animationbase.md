...
state	value string	stopped	READ_ONLY	Indicates the state of the animation. Values include: Value Meaning running Indicates that the animation is in progress paused Indicates that the animation has been paused stopped Indicates that the animation has either run to completion or has been explicitly stopped	Value	Meaning	running	Indicates that the animation is in progress	paused	Indicates that the animation has been paused	stopped	Indicates that the animation has either run to completion or has been explicitly stopped
Value	Meaning
