...
StdDlgTitleArea.
StdDlgContentArea, which may contain the following items: Zero or more StdDlgTextItem nodes (the block(s) of text with the main message). Zero or more StdDlgBulletTextItem nodes (bulleted/numbered list). Zero or more StdDlgTextItem nodes (the block(s) of text with the bottom message).
...
"bullet" (this is the default) "numbered" "lettered" .
