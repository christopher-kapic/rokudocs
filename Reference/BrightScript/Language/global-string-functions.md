...
Unlike the ifStringOps.Mid() method, the first character in the string is
position 1.
...
blank for non-negative numbers is not desired. See ifIntOpts in roInt ).
See the ifStringOps interface in roString for the corresponding inverse /
