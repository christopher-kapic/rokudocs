...
GetOneLineWidth	Integer	Name Type MaxWidth Integer text String	Name	Type	MaxWidth	Integer	text	String	Number of pixels as Integer	Returns the width in pixels occupied by the text (this is capped at the maximum provided value).
Name	Type
MaxWidth	Integer
text	String
