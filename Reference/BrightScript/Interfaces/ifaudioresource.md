...
Implemented by
Name	Description
roAudioResource	The roAudioResouce allows .wav files to be cached to memory and quickly played at any time
...
index	Integer	The index is a value between 0 and MaxSimulStreams() allowing for multiple sounds to be mixed.
...
Description
Returns an roAssociativeArray array containing the indicated metadata parameters about the audio resource.
Return Value
