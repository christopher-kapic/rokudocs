...
Return Value
A flag indicating whether the listen() method has been successfully called on this socket.
Connect() as Boolean
Description
...
Description
Checks whether a connect or accept function has been completed on this socket.
Return Value
