...
Value Scaling mode 0 Nearest neighbor (fast). This is the default. 1 Bilinear (smooth)	Value	Scaling mode	0	Nearest neighbor (fast). This is the default.	1	Bilinear (smooth)
Value	Scaling mode
