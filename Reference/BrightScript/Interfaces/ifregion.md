...
Parameters
Name	Type	Description
mode	Integer	The scaling mode, which may be one of the following values: 0 = fast scaling operation (may have jaggies) 1 = smooth scaling operation (may be slow)
