...
Implemented by
Name	Description
roSocketAddress	The roSocketAddress is used by the roStreamSocket and roDataGramSocket components for TCP and UDP traffic respectively
...
This function is deprecated and should not be used. Use the setMessagePort() function instead.
Description
