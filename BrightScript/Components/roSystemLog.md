...
All of the log event messages are sent to the roMessagePort that is registered on the roSystemLogEvent object. See roSystemLogEvent for details on the messages.
