...
Implemented by
Name	Description
roAppMemoryMonitor	Subscribes channels to low-memory notifications. When an app is subscribed, it receives a roAppMemoryNotificationEvent when it reaches a specific percentage of the per-app memory limit (80%).
