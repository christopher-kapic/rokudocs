...
Implemented by
Name	Description
roBitmap	The roBitmap component contains image data and provides an interface (ifDraw2D) for drawing
roRegion	The roRegion component is used to represent a subsection of a bitmap
...
src	Object	The roBitmap or an roRegion object to be drawn.
...
font	Object	The roFont object to be used for the text.
