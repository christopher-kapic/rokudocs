...
Implemented by
Name	Description
roEVPDigest	The EVP Digest component provides an interface to the OpenSSL EVP library of message digest algorithms
Supported methods
...
Reinit() as Integer
Description
Re-initializes an existing message digest context. This can be called to reuse an existing roEVPDigest object to digest new data.
...
Parameters
Name	Type	Description
bytes	Object	An roByteArray containing digested data
Return Value
...
Parameters
Name	Type	Description
bytes	Object	An roByteArray containing data to be added to the current digest
Final() as String
Description
