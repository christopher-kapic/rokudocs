...
Implemented by
Name	Description
roAudioMetadata	The Audio Player object provides the ability to setup the playing of a series of audio streams
Supported methods
...
Parameters
An array of associative arrays (Content Meta-Data objects) representing the information for each stream to be played. See Content Meta-Data for details on the attributes for each element in the array.
