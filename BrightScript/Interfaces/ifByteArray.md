...
Description
Returns the signed byte at the specified zero-based index in the Byte ArrayUse the ifArrayGet.GetEntry() method or the [ ] array operator to read an unsigned byte in the Byte Array.
