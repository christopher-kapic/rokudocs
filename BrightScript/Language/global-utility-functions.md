...
pattern. Pattern is a wildmat expression. Returns a List object.
...
See the Garbage collection section of this manual for more detail. You don't normally need to call
this function.
For example:
...
The same as the previous FormatJson method , but accepts the flags parameter as a string.
...
the pkg:/locale subdirectory named for the current locale (see ifDeviceInfo.GetCurrentLocale for the list
