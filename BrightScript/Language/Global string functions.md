...
Unlike the ifStringOps.Mid() method, the first character in the string is position 1.
...
See the ifStringOps interface in roString for the corresponding inverse / string-to-value functions ToInt() and ToFloat().
