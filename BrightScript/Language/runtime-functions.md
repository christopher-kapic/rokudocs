...
Eval is deprecated effective immediately. Use of Eval() will cause compilation or runtime errors, see Roku Manifest . Use roXMLElement.parse() or parseJSON() instead of Eval() when initializing data.
