...
Returns the ID of the socket this event is for. The ID of a socket can be obtained from ifSocketAsync.GetID(). Use ifSocketStatus or ifSocketConnectionStatus on the indicated socket to query the new status for the socket.