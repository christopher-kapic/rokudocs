...
Example
MaskGroup shows how to use a MaskGroup node to conceal and reveal a poster.
...
Sample app
MaskGroupExample is a sample app demonstrating MaskGroup in action.
