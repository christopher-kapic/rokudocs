...
textFont	Font	system: MediumSystemFont	READ_WRITE	Specifies the Font node for all unfocused Button nodes in the group. Only set to override the system default. See Font for a list of all system fonts available
focusedTextFont	Font	system: MediumBoldSystemFont	READ_WRITE	Specifies the Font node for the Button node that has focus, if any. Only set to override the system default. See Font for a list of all system fonts available
