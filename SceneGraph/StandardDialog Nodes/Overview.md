...
++++ StandardMessageDialog	Displays a message to the user.	roku400px - standard-message-dialog
++++ StandardKeyboardDialog	Enables text and voice entry of strings consisting of alphanumeric characters as well as many commonly used symbols.	roku400px - keyboard-dialog
++++ StandardPinPadDialog	Enables text and voice entry of numeric digits—typically, short numeric PIN codes.	roku400px - pin-pad
++++ StandardProgressDialog	Displays a spinning progress indicator that includes a short progress message to the user.	roku400px - progress-dialog
...
++StdDlgActionCardItem	Highlights the StdDlgItemBase child nodes in the content area of a custom dialog.	roku400px - StdDlgBulletTextItem
++ StdDlgBulletTextItem	A bulleted list of text.	roku400px - StdDlgBulletTextItem
++ StdDlgDeterminateProgressItem	A progress indicator that represents the percentage of the progress that has been completed.	roku400px - std-dlg-determinate-progress-item
++ StdDlgGraphicItem	An image with an optional text label.	roku400px - v
++ StdDlgKeyboardItem	Either a keyboard or PIN pad for the text and voice entry of alphanumeric/symbol strings or numeric digits (typically, short numeric PIN codes), respectively.	roku400px - std-dlg-keyboard-item
++ StdDlgMultiStyleTextItem	A line of text with multiple styles (for example, plain and bold characters, different fonts, multiple colors, and/or emojis).	roku400px - std-dlg-progress-item
++ StdDlgProgressItem	A spinning progress indicator for tasks that take an indeterminate amount of time.	roku400px - std-dlg-progress-item
++ StdDlgTextItem	A block of text.	roku400px - std-dlg-text-item
++ StdDlgCustomItem	A free-form custom item.	roku400px - custom-item-roku250px
...
roku400px - BasicDialogWithGreenPalette
