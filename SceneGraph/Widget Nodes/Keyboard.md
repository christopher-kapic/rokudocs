...
The Keyboard node class allows a user to enter a string of alphanumeric characters. The string entered is displayed in a TextEditBox node that is part of the Keyboard node.
...
SD Keyboard Template
HD Keyboard Template
FHD Keyboard Template
Sample app
KeyboardExample is a sample app demonstrating Keyboard in action.
