...
the BrightScript Component reference .
Display modes (HD/SD)
...
"voice-search"	Roku Voice search command ( Visual Search Results For Roku Voice ; for example, "Weird")
"voice-command"	Roku Voice command ( Direct-to-Play ; for example, "Play Weird")
"dial"	DIAL protocol
...
Sub RunScreenSaver()
RunScreenSaver is called to launch a screensaver when the Roku has been idle for
