...
Verify that you have created a Roku account and enrolled in the Roku Developer Program .

In the Developer Dashboard, select Payout settings . If you are using the Payout Settings workflow for the first time, review the steps and then click Get started .

Enter or update the following information: Contact information (name, email, address). Entity and payout method (PayPal, ACH [in the US only], or Cross-border wire [non-US only]). Tax form (W9, W8-BEN, W8-BEN-E, W–8 ECI, W–8 EXP, W–8 IMY, or form 8233).

Video demo
<img src='https://image.roku.com/ZHZscHItMTc2/entering-payout-settings.png' alt='Roku Pay: Enrolling in the Roku Partner Payouts Program'Contact information
...
Under Entity & payout method , select Verify entity and then do the following:

Enter your contact information, and then select Submit .

Enter your Tax Details , and then select Submit .

Enter your Banking Information , and then select Submit. You can choose one of the following payout methods: PayPal: Your PayPal account must be linked to a valid payout method (for example, a bank account). Payouts are subject to PayPal terms. ACH (US only): This option is only available to publishers located in the United States. ACH payouts are made in USD only (non-USD transactions are converted to USD using the average foreign exchange rate for the month in which the payment occurs). ACH payouts are subject to additional bank fees. Routing and account numbers must be entered accurately; entering incorrect bank account information will cause payouts to fail. Cross-border wire (non-US only; availability varies by region): This option is only available to publishers located outside the United States, and support for this payout method varies based on the region.

Tax forms
Once your entity and payout method have been verified, provide your tax forms following these steps:
Select Complete tax forms (this button is unavailable until all your information has been completed and validated), and then complete the following steps:

Confirm your source of income, select the confirmation checkbox, and then select Continue .

Record your confirmation code, enter code recovery information, and then select Continue .

Select the applicable tax form for your region and entity and then select Continue .
...
Select your US federal tax classification (corporation, partnership, LLC, and so on) enter the required information, and then select Continue .

Enter your exemptions from backup withholding and then select Continue .

Verify your tax identification number (TIN) and then select Continue .

Upload the required supporting documentation (affidavit, certificate of incorporation, withholding/allocation statement, and so on) and any other additional documentation, and then select Confirm & Continue .

Select the applicable certification checkboxes and then select Continue .

Electronically sign your form, enter the confirmation code you received in step b, select the declaration acceptance check box, and then select Submit Electronically .

A dialog opens confirming that the withholding certification submission process has been completed. Optionally, you can select Download PDF to receive an electronic copy of the submitted forms.

Select Exit to return to the Developer Dashboard.
