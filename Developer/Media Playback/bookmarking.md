...
Channels must implement bookmarking in VOD content that is longer that 15 minutes to pass certification .
...
To write to the registry, use the roRegistrySection component.
