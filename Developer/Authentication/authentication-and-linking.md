Rendezvous linking
All apps, except TVE apps, must complete authentication entirely on-device to pass certification. See On-device authentication for how to implement the required authentication method.
...
Display a short on-screen registration code (generated on the
