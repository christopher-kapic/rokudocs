...
a SceneGraph application. Many of the renderable nodes include a uri field that allows you specify the URI of a graphical image file or other
...
strings for a LabelList node, the component can set the control field of the Task node object to RUN . This sends the specified
...
field. This change in the field value triggers the observeField() callback function in the component XML file to add the strings to the
