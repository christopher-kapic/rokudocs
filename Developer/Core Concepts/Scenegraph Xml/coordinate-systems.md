...
Translate by the inverse of the scale/rotate center
Multiplying by the scale amount
Apply the Z-axis rotation
Translate by the scale/rotate center
Translate by the translation amount.
...
accumulated transformation matrix. For example, in a PanelSet node screen, each Panel node has a local origin of (0,0) at the
